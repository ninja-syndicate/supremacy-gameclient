...
enum class EMapEventType : uint8
{
	...
	MapEventType_HiveHexRaised UMETA(DisplayName = "Hive Hex Raised", ToolTip = "The ids of the hexs that have recently raised."),
	MapEventType_HiveHexLowered UMETA(DisplayName = "Hive Hex Lowered", ToolTip = "The ids of the hexs that have recently lowered."),
};
