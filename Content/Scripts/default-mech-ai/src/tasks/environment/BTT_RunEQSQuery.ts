 ...
 *
 * Depending on the environment query type, you may need to execute {@link BTT_QuerySetArgumentString} or {@link BTT_QuerySetArgumentVector} to set the
 * arguments for the query before executing this task.
 *
