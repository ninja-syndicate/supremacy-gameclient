...
export const BT_Camp = new Sequence({
    nodes: [
        BTT_EQSSetArgumentString(EQSQueryType.Cover, EQSArgument.TargetHash, (blackboard: AIBlackboard) => blackboard.target.hash),
        BTT_EQSSetArgumentString(EQSQueryType.Cover, EQSArgument.LastHitLocation, (blackboard: AIBlackboard) => blackboard.LastHitLocation),
